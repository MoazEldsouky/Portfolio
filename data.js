...
const PORTFOLIO_DATA = {
  ...
  skills: [
    { id: "s1", category: "Programming", items: ["Python", "SQL"] },
    { id: "s2", category: "AI/ML Frameworks", items: ["PyTorch", "TensorFlow", "Keras", "Scikit-learn", "XGBoost", "LightGBM", "CatBoost"] },
    { id: "s3", category: "NLP & LLMs", items: ["Hugging Face Transformers", "LangChain", "LangGraph", "CrewAI", "OpenAI API", "Claude (Anthropic)", "Groq", "Gemini", "spaCy", "NLTK"] },
    { id: "s4", category: "LLM Techniques", items: ["Fine-tuning (LoRA, QLoRA)", "Prompt Engineering", "RAG", "Agentic AI", "Text Classification", "NER", "Sentiment Analysis", "Question Answering", "Summarization", "Computer Vision"] },
    { id: "s5", category: "Vector Databases", items: ["FAISS", "Chroma", "Pinecone"] },
    { id: "s6", category: "MLOps & Deployment", items: ["FastAPI", "REST APIs", "Docker", "CI/CD Pipelines", "Azure", "AWS", "Cloud Computing", "Model Drift Monitoring"] },
    { id: "s7", category: "Data Science", items: ["Pandas", "NumPy", "Matplotlib", "Seaborn", "Plotly", "Data Preprocessing"] },
    { id: "s8", category: "Dev Tools", items: ["VS Code", "Cursor", "Windsurf", "Git", "GitHub", "Jupyter Notebook", "Google Colab", "n8n"] }
  ],
  experience: [
    {
      id: "e1",
  ...
  projects: [
    {
      ...
      stack: ["Python", "LangGraph", "LangChain", "OpenAI API", "FAISS", "Gradio"],
    ...
    },
    {
      ...
      stack: ["Python", "Hugging Face Transformers", "AraBERTv02", "Gradio"],
    ...
    },
    {
      ...
      stack: ["Python", "Scikit-learn", "SVM", "TF-IDF", "Hugging Face"],
    ...
    },
    {
      ...
      stack: ["Python", "PyTorch", "Hugging Face Transformers", "DeBERTa"],
